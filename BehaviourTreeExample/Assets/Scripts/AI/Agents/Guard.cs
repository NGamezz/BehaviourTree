            ...
            new BTSequence(
                ...
                new BTRepeatWhile(() => blackBoard.GetVariable<bool>(VariableNames.IS_ATTACKING),
                    new BTSelector(
                        ...
                        new BTSequence(
                            new BTAlwaysSuccesTask(() => blackBoard.GetVariable<IWeapon>(VariableNames.ENEMY_CURRENT_WEAPON).Attack()),
                            new BTConditionNode(() => Vector3.Distance(transform.position, blackBoard.GetVariable<Transform>(VariableNames.PLAYER_TRANSFORM).position) < attackRange + 1.0),
                            new BTWaitFor(0.5f)
                        ),
